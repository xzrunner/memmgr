...
#ifndef _MEMMGR_BLOCK_ALLOCATOR_H_
#define _MEMMGR_BLOCK_ALLOCATOR_H_
...
private:
    ...
    BlockAllocator(const BlockAllocator& clone);
    BlockAllocator &operator=(const BlockAllocator &rhs);
};
}

#endif // _MEMMGR_BLOCK_ALLOCATOR_H_